...
route.post('/self_transfer',(req,res)=>{
    user.findOne({username:req.body.username})
    .then((result)=>{
            console.log('in self transfer')
            const add_amount=parseInt(req.body.add_amount)
            const final_amount=result.balance+add_amount
            result.balance=final_amount
            result.save()
